...
class RecipesData {
  static List<Recipe> dessertMenu = [
    Recipe(
      id: 1,
      ...
      image: Assets.images.desserts.lemoncake.path,
      bgImageName: Assets.images.desserts.lemoncheesecakebg.path,
    ...
    Recipe(
      ...
      image: Assets.images.desserts.macaroons.path,
      bgImageName: '',
    ...
    Recipe(
      ...
      image: Assets.images.desserts.creamcupcakes.path,
      bgImageName: '',
    ...
    Recipe(
      ...
      image: Assets.images.desserts.chocolatecake1.path,
      bgImageName: '',
    ...
    Recipe(
      ...
      image: Assets.images.desserts.fruitplate.path,
      bgImageName: '',
    ...
    Recipe(
      ...
      image: Assets.images.desserts.chocolatedonuts.path,
      bgImageName: '',
    ...
    Recipe(
      ...
      image: Assets.images.desserts.strawberrypowderedcake.path,
      bgImageName: '',
    ...
    Recipe(
      ...
      image: Assets.images.desserts.fluffycake.path,
      bgImageName: '',
      bgColor: AppColors.orangeDark,
    ),
    Recipe(
      ...
      image: Assets.images.desserts.whitecreamcake.path,
      bgImageName: '',
      bgColor: AppColors.sugar,
    ),
    Recipe(
      ...
      image: Assets.images.desserts.fruitpie.path,
      bgImageName: '',
      bgColor: AppColors.yellow,
    ),
    Recipe(
      ...
      image: Assets.images.desserts.honeycake.path,
      bgImageName: '',
    ...
    Recipe(
      ...
      image: Assets.images.desserts.powderedcake.path,
      bgImageName: '',
      bgColor: AppColors.sugar,
    ),
    Recipe(
      ...
      image: Assets.images.desserts.strawberries.path,
      bgImageName: '',
      bgColor: AppColors.red,
    ),
    Recipe(
      ...
      image: Assets.images.desserts.chocolatecake2.path,
      bgImageName: '',
      bgColor: AppColors.orangeDark,
    ),
    Recipe(
      ...
      image: Assets.images.desserts.applepie.path,
      bgImageName: '',
      bgColor: AppColors.sugar,
    ),
  ];
